...
export const certifications: Array<{title: string, images: string[]}> = [
    {
    ...
    {
        title: "MTA – HTML5 App Development",
        images: [
            require("./images/HTML5ApplicationDevelopmentFundamentals.jpg"),
        ],
    },
    {
        title: "CTE – Computer Programming",
        images: [
